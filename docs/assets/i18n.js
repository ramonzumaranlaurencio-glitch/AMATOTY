...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      amz_title:          '🛒 Search on Amazon',
      amz_close_title:    'Close',
      amz_disclaimer:     '📢 <strong>Affiliate notice:</strong> As an Amazon Associate we earn from qualifying purchases. Prices and availability are set by Amazon and may vary.',
      amz_recent:         '🕐 Recent searches',
      amz_clear_all:      'Clear all',
      amz_view_on:        'View on Amazon →',
      amz_card_all:       'All results',
      amz_card_all_d:     'All "{q}" products available on Amazon',
      amz_card_top:       'Top rated',
      amz_card_top_d:     'Highest rated by verified buyers',
      amz_card_low:       'Lowest price',
      amz_card_low_d:     'Sorted from lowest to highest price',
      amz_card_new:       'New arrivals',
      amz_card_new_d:     'Latest models and recent releases',
      amz_card_choice:    "Amazon's Choice",
      amz_card_choice_d:  'High rating, great price and reliable shipping',
      amz_card_prime:     'Prime shipping',
      amz_card_prime_d:   'Eligible for fast delivery with Amazon Prime',
    },
    es: {
      nav_home:           'Inicio',
      ...
      // Sección afiliado Amazon
      amz_title:          '🛒 Buscar en Amazon',
      amz_close_title:    'Cerrar',
      amz_disclaimer:     '📢 <strong>Aviso de afiliado:</strong> Como Asociado de Amazon, ganamos una comisión por compras que califiquen. El precio y la disponibilidad son responsabilidad de Amazon y pueden variar.',
      amz_recent:         '🕐 Búsquedas recientes',
      amz_clear_all:      'Borrar todo',
      amz_view_on:        'Ver en Amazon →',
      amz_card_all:       'Todos los resultados',
      amz_card_all_d:     'Todos los productos de "{q}" disponibles en Amazon',
      amz_card_top:       'Mejor valorados',
      amz_card_top_d:     'Los más valorados por compradores verificados',
      amz_card_low:       'Precio más bajo',
      amz_card_low_d:     'Ordenados de menor a mayor precio',
      amz_card_new:       'Últimas llegadas',
      amz_card_new_d:     'Modelos y lanzamientos más recientes',
      amz_card_choice:    "Amazon's Choice",
      amz_card_choice_d:  'Alta calificación, buen precio y envío confiable',
      amz_card_prime:     'Envío Prime',
      amz_card_prime_d:   'Elegibles para entrega rápida con Amazon Prime',
    },
    pt: {
      nav_home:           'Início',
      nav_smart_search:   'Busca Inteligente',
      ...
      amz_disclaimer:     '📢 <strong>Aviso de afiliado:</strong> Como Associado Amazon, ganhamos comissão em compras qualificadas. Preços e disponibilidade são de responsabilidade da Amazon e podem variar.',
      amz_recent:         '🕐 Buscas recentes',
      amz_clear_all:      'Apagar tudo',
      amz_view_on:        'Ver na Amazon →',
      amz_card_all:       'Todos os resultados',
      amz_card_all_d:     'Todos os produtos de "{q}" disponíveis na Amazon',
      amz_card_top:       'Mais bem avaliados',
      amz_card_top_d:     'Os mais avaliados por compradores verificados',
      amz_card_low:       'Menor preço',
      amz_card_low_d:     'Ordenados do menor ao maior preço',
      amz_card_new:       'Novidades',
      amz_card_new_d:     'Modelos e lançamentos mais recentes',
      amz_card_choice:    "Amazon's Choice",
      amz_card_choice_d:  'Alta avaliação, bom preço e entrega confiável',
      amz_card_prime:     'Entrega Prime',
